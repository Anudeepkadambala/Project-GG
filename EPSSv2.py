...
async def call_api_with_cve_and_merge(base_url, input_file, output_file):
    try:
        ...
        # here iit is parsing json into csv format and giving result in different cell
        for key in results:
            data = results[key]
            for item in data:
        ...
        print("Merged data exported to", output_file)
...
if __name__ == "__main__":
    ...
    input_file = input("Enter the path of the source file :")
